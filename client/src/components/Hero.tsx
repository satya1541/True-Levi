      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <span className="px-4 py-2 rounded-full bg-accent/10 text-accent-foreground text-sm font-medium border border-accent/30">
            ...
            >
              From company registration to tax compliance, we provide comprehensive financial and business consulting services to help your business thrive.
            </motion.p>
